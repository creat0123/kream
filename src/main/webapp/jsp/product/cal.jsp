        ...
        var events = [
          <% 
            ...
            try {
              ...
              //conn = DriverManager.getConnection("jdbc:mariadb://localhost:3306/kream", "kream", "1234");
              conn = DriverManager.getConnection("jdbc:mariadb://database-1.czvkokmis90c.ap-northeast-2.rds.amazonaws.com:3306/kream", "kream", "kream1234");
